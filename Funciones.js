...
const crearRegistroAspirante=(aspirante)=>{
	...
	if(!encontrado){//validacion de duplicado
		console.log('El aspirante aun no se ha registrado en el sistema')
	}else{
	let duplicadoUsu=listaRegistro.find(nom=>nom.nombrecurso==aspirante.nombrecurso && nom.nombre==aspirante.nombre);
	 if(!duplicadoUsu){
